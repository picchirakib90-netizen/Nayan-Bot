    ...
    try {
      ...
      if (!msg) {
        const greetings = [
          ...
          "​ٱلسَّلَامُ عَلَيْكُمْ বলেন আপনার জন্য কি করতে পারি",
          "আমাকে এতো না ডেকে বস আসিফ একটা গফ দে 🙄",
          "প্রেম করতে চাইলে বস আসিফ এর ইনবক্স এ নক দাও https://www.facebook.com/profile.php?id=61584656504701",
          "jang bal falaba🙂"
        ];
